...
document.addEventListener('DOMContentLoaded', () => {
    ...
    function updateHistory(page) {
        const state = { url: `/partner/notifications?page=${page}`, title: "Уведомления" };
    ...
    async function fetchNotifications(page = null) {
        ...
        const response = await fetch(`/partner/notifications/json?page=${page}`, {
            method: "GET",
    ...
    async function handleMarkAsRead(e) {
        ...
        try {
            const response = await fetch(`/partner/notifications/mark/${id}`, {
                method: "POST",
                body: formData,
    ...
    async function markAllAsRead(e) {
        ...
        try {
            const response = await fetch(`/partner/notifications/mark-all`, {
                method: "POST",
                body: formData,
                credentials: "same-origin"
            });
